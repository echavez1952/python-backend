...
# Explicacion del uso de la ruta /product/componet/
...
# FastAPI espera que el nuevo title y component_id se envíen
# como query parameters en el POSTMAN o form data
